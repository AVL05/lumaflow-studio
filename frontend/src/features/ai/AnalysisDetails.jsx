...
export function AnalysisDetails({ analysis }) {
  if (!analysis)
    return <p className="text-sm text-stone-400">Selecciona una foto y genera un analisis.</p>;
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {[
          ...
          <div key={key} className="rounded-lg bg-white/[0.04] p-3">
            <p className="text-xs uppercase tracking-[0.14em] text-stone-400">{key}</p>
