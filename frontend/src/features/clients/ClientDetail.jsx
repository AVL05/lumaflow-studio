  ...
  return (
    <Card className="p-5">
      ...
      <div className="mt-6 grid gap-4 text-sm text-stone-400 md:grid-cols-2">
        <p><span className="text-stone-100">Email:</span> {client.email || 'Sin email'}</p>
        <p><span className="text-stone-100">Telefono:</span> {client.phone || 'Sin telefono'}</p>
        <p><span className="text-stone-100">Instagram:</span> {client.instagram || 'Sin Instagram'}</p>
        <p><span className="text-stone-100">Entregas:</span> {client.deliveries_count ?? 0}</p>
      </div>
