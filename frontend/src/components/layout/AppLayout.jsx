      ...
      <aside className="fixed inset-y-0 left-0 hidden w-72 overflow-y-auto border-r border-white/10 bg-[#0d0c0b]/95 p-5 lg:flex lg:flex-col">
        ...
        <nav className="mt-8 space-y-6">
          {navGroups.map(([group, items]) => (
            <div key={group}>
              <p className="px-3 pb-2 text-[10px] uppercase tracking-[0.2em] text-stone-600">
                {group}
              </p>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <button
                ...
                className="hidden items-center gap-3 rounded-md border border-white/10 bg-white/[0.04] px-3 py-2 text-sm text-stone-500 transition hover:bg-white/[0.08] hover:text-stone-200 md:flex"
              >
                Buscar
                <kbd className="rounded border border-white/10 px-1.5 py-0.5 text-[10px] text-stone-500">
                  Ctrl K
                </kbd>
              </button>
