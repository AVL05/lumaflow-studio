...
export const aiApi = {
  ...
  chat: (payload, config = {}) => apiClient.post('/ai/chat', payload, config).then((res) => res.data),
  ...
  sessionPlan: (payload) => apiClient.post('/ai/session-plan', payload).then((res) => res.data.data),
  recommendGear: (payload) => apiClient.post('/ai/recommend-gear', payload).then((res) => res.data.data),
  ...
  updateHistory: (id, payload) => apiClient.patch(`/ai/history/${id}`, payload).then((res) => res.data.data),
