...
export const publicApi = {
  ...
  book: (slug, payload) => apiClient.post(`/public/studios/${slug}/bookings`, payload).then((res) => res.data),
  ...
  requestDeliveryChanges: (token, message) =>
    apiClient.post(`/public/deliveries/${token}/request-changes`, { message }).then((res) => res.data.data),
};
